  ...
  return (
    <footer>
      <div className="footer-sec-1">
        <div className="max-width sec-1-body">
          <div className="collection-title">Explore options near me</div>
          <div className="sec-1-rows">
            <div className="sec-1-row">
              <div className="row-text"> Popular cuisines near me</div>
              <i className="fi fi-rs-angle-small-down absolute-center row-arrow"></i>
            </div>
            <div className="sec-1-row">
              <div className="row-text">Popular restaurant types near me</div>
              <i className="fi fi-rs-angle-small-down absolute-center row-arrow"></i>
            </div>
            <div className="sec-1-row">
              <div className="row-text">Top Restaurant Chains</div>
              <i className="fi fi-rs-angle-small-down absolute-center row-arrow"></i>
            </div>
            <div className="sec-1-row">
              <div className="row-text">Cities We Deliver To</div>
              <i className="fi fi-rs-angle-small-down absolute-center row-arrow"></i>
            </div>
          </div>
        </div>
      ...
      <div className="footer-sec-2">
        <div className="max-width sec-2-body">
          <div className="footer-logo-location">
            ...
            <div className="footer-location-language">
              <div className="footer-box">
                <img src={flag} alt="India location" />
                <span className="footer-text">India</span>
                <i className="fi fi-rs-angle-small-down absolute-center"></i>
              </div>
              <div className="footer-box">
                <i className="fi fi-rr-globe absolute-center"></i>
          ...
          <div className="footer-info">
            <div className="footer-col">
              <span className="col-head">ABOUT ZOMATO</span>
              <span className="col-text">Who We Are</span>
              <span className="col-text">Blog</span>
              <span className="col-text">Work With Us</span>
              <span className="col-text">Investor Relations</span>
              <span className="col-text">Report Fraud</span>
              <span className="col-text">Contact Us</span>
            </div>
            <div className="footer-col">
              <span className="col-head">ZOMAVERSE</span>
              <span className="col-text">Zomato</span>
              <span className="col-text">Blinkit</span>
              <span className="col-text">Feeding India</span>
              <span className="col-text">Hyperpure</span>
              <span className="col-text">Zomaland</span>
            </div>
            <div className="footer-col">
              <div className="footer-col">
                <span className="col-head">FOR RESTAURANTS</span>
                <span className="col-text">Partner With Us</span>
                <span className="col-text">Apps For You</span>
              </div>
              <div className="footer-col">
                <span className="col-head">FOR ENTERPRISES</span>
                <span className="col-text">Zomato For Work</span>
              </div>
            </div>
            <div className="footer-col">
              <span className="col-head">LEARN MORE</span>
              <span className="col-text">Privacy</span>
              <span className="col-text">Security</span>
              <span className="col-text">Terms</span>
              <span className="col-text">Sitemap</span>
            </div>
            <div className="footer-col">
              <span className="col-head">SOCIAL LINKS</span>
